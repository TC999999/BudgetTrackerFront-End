...
const LoadingMsg = () => {
  ...
  return userStatus.loading ? (
    <div
      tabIndex={-1}
      className="loading-message-div bg-gray-500 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0  max-h-full"
    >
