...
const useIncomeForm = ({
  ...
  const handleTime = (e: React.ChangeEvent<HTMLSelectElement>): void => {
    e.preventDefault();
  ...
  const handleDate = (e: React.ChangeEvent<HTMLSelectElement>): void => {
    e.preventDefault();
    let { value } = e.target;
    setFormData((data) => ({
      ...data,
  ...
  // and month values back to default.
  const handleWeek = (e: React.ChangeEvent<HTMLSelectElement>): void => {
    e.preventDefault();
    let { value } = e.target;
