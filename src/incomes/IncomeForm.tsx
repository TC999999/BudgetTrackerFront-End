    ...
    <Modal large={true} show={show}>
      ...
      <form id="new-income-form" onSubmit={handleSubmit}>
        ...
        >
          ...
          <section id="update-schedule">
                ...
                <div id="minute-select-div">
                  ...
                  >
                    {Array.from(minutes).map(([k, v]) => (
                      <option
                        className={`hover:bg-green-200 w-full ${
                          formData.updateTime.minute === k ? "bg-green-300" : ""
                        }`}
                        key={`minute-${k}`}
                        value={k}
                      >
            ...
            <section id="income-date-input">
              ...
              <div className="flex justify-center w-full">
                <div id="dayOfMonth-div" className="mx-2">
                  ...
                  <select
                    ...
                    size={5}
                  >
                    {Array.from(getDaysInAMonth(formData.updateTime.month)).map(
                      ([k, v]) => (
                        <option
                          className={`hover:bg-green-200 w-full
                        ${
              ...
              <div className="flex justify-center">
                <div id="date-requirements" className="flex flex-col sm:w-72">
                  <small>Adjust the date with the sliders above.</small>
                  <small>
                    To avoid any possible errors, you are only allowed to input
                    daily, weekly, monthly, or yearly incomes.
                  </small>
                </div>
              </div>
            </section>
        ...
        <div id="buttons" className="flex justify-between m-2">
          <button className="cancel-button" onClick={(e) => hide(e)}>
            Cancel
          </button>
